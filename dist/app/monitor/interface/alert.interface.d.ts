...
export type createAlert = Pick<AlertRecords, "action" | "comment" | "student" | "alert">;
...
export declare enum selectedDecision {
...
export type pepEnhancedDueDiligence = Pick<SelectAction, "alertId" | "eddType" | "pepCategory" | "countryOfResidence" | "occupation" | "publicFunction" | "positionLevel" | "governmentEntity" | "isControlOverPublicFunds" | "isRoleLinkedToHighValue" | "familyMemberOfAPep" | "estimatedNetWorth" | "sourceOfWealthDocumentation" | "sourceOfFund" | "sourceOfFundDocumentation" | "offshoreStructure" | "isPepHighRiskOrSanctioned" | "hasNameInCorruptionInvestigations" | "adverseMediaFindingsOnPep" | "willEnhancedMonitoringBeApplied" | "willSeniorManagementSignOff" | "frequencyOfOngoingDueDiligenceChecks" | "seniorManagementApproval" | "approverName" | "department" | "position" | "documentUploadAndSupportingEvidence" | "supportingLinks" | "eddDecision" | "addCustomerToPEPRegisterForOngoingMonitoring" | "decisionRationale" | "finalDecisionRationale" | "finalCaseDecision">;
export type sanctionReview = Pick<SelectAction, "alertId" | "eddType" | "documentsObtained" | "identityVerificationNotes" | "identifyDocuments" | "kycOrEDDReviewFindings" | "adverseMediaFinding" | "shareholdersChecks" | "directorsChecks" | "authoritiesScreening" | "pastCurrentAndPendingTransactions" | "counterParty" | "sanctionReviewChecklist" | "matchType" | "recommendedActionAction" | "commentsAndRationale" | "finalDecisionRationale" | "finalCaseDecision">;
export type financialCrime = Pick<SelectAction, "alertId" | "eddType" | "fullNameOfEntity" | "countryOfIncorporation" | "natureOfBusinessOrOccupation" | "complexOwnershipStructure" | "sourceOfWealths" | "sourceOfFunds" | "financialProduct" | "thirdPartyPayment" | "familyMemberOfAPep" | "relationshipNote" | "sanctionTouchPoints" | "sanctionTouchPointsNote" | "adverseNewsOrMedia" | "adverseNewsOrMediaNote" | "businessOperationsCountries" | "primaryCustomersOrSuppliersCountries" | "fundFlowCountries" | "isAnyCountriesHighRisk" | "finalRiskRating" | "riskDriverSummary" | "mitigatingMeasures" | "finalDecisionRationale" | "finalCaseDecision">;
export type investigate = Pick<SelectAction, "alertId" | "investigationDecision" | "reportableOffense" | "jurisdiction" | "authority" | "assignTo" | "investigationNote" | "evidence">;
export type escalate = Pick<SelectAction, "alertId" | "escalationLevel" | "escalationNotes">;
